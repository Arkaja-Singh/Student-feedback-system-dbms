...
<div class="container">
	...
	<form method="post" enctype="multipart/form-data">
		<table class="table table-bordered" style="margin-top:20px;margin-bottom:50px">
			...
			<tr>
				<td>
					<font color="greenyellow">Name:</font>
				</td>
				<Td><input type="text" name="name" class="form-control" required></td>
			</tr>
			<tr>
				<td>
					<font color="greenyellow">Email:</font>
				</td>
			...
			<tr>
				<td>
					<font color="greenyellow">Password:</font>
				</td>
			...
			<tr>
				<td>
					<font color="greenyellow">Mobile:</font>
				</td>
			...
			<tr>
				<td>
					<font color="greenyellow">Branch:</font>
				</td>
			...
			<tr>
				<td>
					<font color="greenyellow">Select Your Semester</font>
				</td>
			...
			<tr>
				<td>
					<font color="greenyellow">Select Your Gender</font>
				</td>
				<td>
			...
			<tr>
				<td>
					<font color="greenyellow">Enter Your DOB</font>
				</td>
				<Td>
