  ...
  ?>
    <div id="slideshow">
      <div class="slide-wrapper">
        ...
        <div class="slide">
          <img src="f6.jpg" style="height: 600px; width: 1110px;">
        </div>
        <div class="slide">
          <img src="f4.jpg" style="height: 600px; width: 1110px;">
        </div>
        <div class="slide">
          <img src="f1.png" style="height: 600px; width: 1110px;">
        </div>
        <div class="slide">
          <img src="f5.jpg" style="height: 600px; width: 1110px;">
        </div>
      </div>
    </div>
    <div class="copyrightSection">
      <div class="col-md-12 text-center container">
        <p>&copy; Copyright Arkaja-Singh & Shivani-Chaudhary 2021</p>
      </div>
    </div>
